# Description - Create group transactions using the Python SDK py-algorand-sdk
# Before running, make sure you have installed py-algorand-sdk i.e. pip install py-algorand-sdk
# Usage - $ python tomic_transactions.py
